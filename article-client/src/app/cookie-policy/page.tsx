...
export default function CookiePolicyPage() {
  return <ContentPage title="Cookie Policy" description="This policy explains how Cognora uses cookies and similar browser technologies, and how you can control them." path="/cookie-policy" updated="August 5, 2026">
    ...
    <section><h2>Google AdSense and third parties</h2><p>If Cognora introduces Google AdSense, Google and participating partners may place or read cookies and use related signals to deliver and measure ads. Depending on your region, non-essential advertising cookies will be used only after required notice or consent. You can manage personalization through <a href="https://adssettings.google.com/" target="_blank" rel="noopener noreferrer">Google&apos;s Ads Settings</a> and review <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer">Google&apos;s partner-site data explanation</a>. Other providers may use cookies when you open embedded or linked third-party services, subject to their own policies.</p></section>
    <section><h2>Consent in the EEA, United Kingdom, and Switzerland</h2><p>Before serving Google personalized or non-personalized ads in regions where consent is required, Cognora will use a Google-certified consent management platform to provide the required disclosures, record valid choices, and let users withdraw or change consent. Advertising storage will not be activated for those users until the applicable consent requirements have been addressed.</p></section>
